...
class User extends Authenticatable
{
    ...
    public function func5(string $a): int
    {
        return $a . 'foo';
    }

    public function func6(string $a): int
    {
        return $a . 'foo';
    }

    public function func7(string $a): int
    {
        return $a . 'foo';
    }

    public function func8(string $a): int
    {
        return $a . 'foo';
    }

    public function func9(string $a): int
    {
        return $a . 'foo';
    }
}
